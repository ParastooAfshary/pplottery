...
strncmp(const char *p, const char *q, uint n)
{
 ...
 2cc:	0800                	addi	s0,sp,16
  while(n > 0 && *p && *p == *q)
 2ce:	ce11                	beqz	a2,2ea <strncmp+0x22>
 2d0:	00054783          	lbu	a5,0(a0)
 2d4:	cf89                	beqz	a5,2ee <strncmp+0x26>
 2d6:	0005c703          	lbu	a4,0(a1)
 2da:	00f71a63          	bne	a4,a5,2ee <strncmp+0x26>
    n--, p++, q++;
 2de:	367d                	addiw	a2,a2,-1
 2e0:	0505                	addi	a0,a0,1
 2e2:	0585                	addi	a1,a1,1
  while(n > 0 && *p && *p == *q)
 2e4:	f675                	bnez	a2,2d0 <strncmp+0x8>
  if(n == 0)
    return 0;
 2e6:	4501                	li	a0,0
 2e8:	a801                	j	2f8 <strncmp+0x30>
 2ea:	4501                	li	a0,0
 2ec:	a031                	j	2f8 <strncmp+0x30>
  return (uchar)*p - (uchar)*q;
 2ee:	00054503          	lbu	a0,0(a0)
 2f2:	0005c783          	lbu	a5,0(a1)
 2f6:	9d1d                	subw	a0,a0,a5
}
 2f8:	6422                	ld	s0,8(sp)
