...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     184:	183040ef          	jal	4b06 <unlink>
  close(fd1);
     188:	8526                	mv	a0,s1
     18a:	155040ef          	jal	4ade <close>
  close(fd2);
     18e:	854a                	mv	a0,s2
     190:	14f040ef          	jal	4ade <close>
}
...
00000000000001b8 <createtest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     1e4:	113040ef          	jal	4af6 <open>
    close(fd);
     1e8:	0f7040ef          	jal	4ade <close>
  for(i = 0; i < N; i++){
...
000000000000022c <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    if(fd < 0){
     ...
     28a:	85d2                	mv	a1,s4
     28c:	854a                	mv	a0,s2
     28e:	049040ef          	jal	4ad6 <write>
      if(cc != sz){
     292:	04951263          	bne	a0,s1,2d6 <bigwrite+0xaa>
    close(fd);
     296:	854a                	mv	a0,s2
     298:	047040ef          	jal	4ade <close>
    unlink("bigwrite");
     29c:	8556                	mv	a0,s5
     29e:	069040ef          	jal	4b06 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
...
badwrite(char *s)
{
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    write(fd, (char*)0xffffffffffL, 1);
     32c:	4605                	li	a2,1
     32e:	85d2                	mv	a1,s4
     330:	7a6040ef          	jal	4ad6 <write>
    close(fd);
     334:	8526                	mv	a0,s1
     336:	7a8040ef          	jal	4ade <close>
    unlink("junk");
     33a:	854e                	mv	a0,s3
     33c:	7ca040ef          	jal	4b06 <unlink>
  for(int i = 0; i < assumed_free; i++){
  ...
  if(write(fd, "x", 1) != 1){
    ...
    exit(1);
     3a0:	4505                	li	a0,1
     3a2:	714040ef          	jal	4ab6 <exit>
  }
  close(fd);
     3a6:	8526                	mv	a0,s1
     3a8:	736040ef          	jal	4ade <close>
  unlink("junk");
     3ac:	00005517          	auipc	a0,0x5
     3b0:	e1450513          	addi	a0,a0,-492 # 51c0 <malloc+0x21e>
     3b4:	752040ef          	jal	4b06 <unlink>

  exit(0);
     3b8:	4501                	li	a0,0
     3ba:	6fc040ef          	jal	4ab6 <exit>
...
00000000000006e0 <truncate1>:
{
  ...
  write(fd1, "abcdef", 6);
     ...
     796:	854e                	mv	a0,s3
     798:	33e040ef          	jal	4ad6 <write>
  n = read(fd3, buf, sizeof(buf));
     79c:	02000613          	li	a2,32
     7a0:	fa040593          	addi	a1,s0,-96
     7a4:	854a                	mv	a0,s2
     7a6:	328040ef          	jal	4ace <read>
  if(n != 6){
     7aa:	4799                	li	a5,6
  ...
  unlink("truncfile");
     ...
     7cc:	33a040ef          	jal	4b06 <unlink>
  close(fd1);
     7d0:	854e                	mv	a0,s3
     7d2:	30c040ef          	jal	4ade <close>
  close(fd2);
     7d6:	8526                	mv	a0,s1
     7d8:	306040ef          	jal	4ade <close>
  close(fd3);
     7dc:	854a                	mv	a0,s2
     7de:	300040ef          	jal	4ade <close>
}
...
0000000000000b1e <unlinkread>:
{
  ...
  write(fd, "hello", SZ);
     ...
     b4e:	789030ef          	jal	4ad6 <write>
  close(fd);
     b52:	8526                	mv	a0,s1
     b54:	78b030ef          	jal	4ade <close>
  fd = open("unlinkread", O_RDWR);
     b58:	4589                	li	a1,2
     b5a:	00005517          	auipc	a0,0x5
     b5e:	a7650513          	addi	a0,a0,-1418 # 55d0 <malloc+0x62e>
     b62:	795030ef          	jal	4af6 <open>
     b66:	84aa                	mv	s1,a0
  if(fd < 0){
...
0000000000000c74 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cba:	61d030ef          	jal	4ad6 <write>
     cbe:	4795                	li	a5,5
     cc0:	0cf51e63          	bne	a0,a5,d9c <linktest+0x128>
  close(fd);
     cc4:	8526                	mv	a0,s1
     cc6:	619030ef          	jal	4ade <close>
  if(link("lf1", "lf2") < 0){
...
0000000000000fd4 <pgbug>:
{
  ...
  exec(big, argv);
     ...
     fee:	6088                	ld	a0,0(s1)
     ff0:	2ff030ef          	jal	4aee <exec>
  pipe(big);
     ff4:	6088                	ld	a0,0(s1)
     ff6:	2d1030ef          	jal	4ac6 <pipe>
  exit(0);
     ffa:	4501                	li	a0,0
     ffc:	2bb030ef          	jal	4ab6 <exit>
...
000000000000103e <copyinstr2>:
{
  ...
  ret = exec(b, args);
    ...
    10a8:	247030ef          	jal	4aee <exec>
  if(ret != -1){
    10ac:	57fd                	li	a5,-1
    10ae:	0cf51563          	bne	a0,a5,1178 <copyinstr2+0x13a>
  int pid = fork();
    10b2:	1fd030ef          	jal	4aae <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    exit(1);
    119c:	4505                	li	a0,1
    119e:	119030ef          	jal	4ab6 <exit>
    exit(747); // OK
    11a2:	2eb00513          	li	a0,747
    11a6:	111030ef          	jal	4ab6 <exit>
  int st = 0;
    11aa:	f4042a23          	sw	zero,-172(s0)
  wait(&st);
    11ae:	f5440513          	addi	a0,s0,-172
    11b2:	10d030ef          	jal	4abe <wait>
  if(st != 747){
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f4:	103030ef          	jal	4af6 <open>
    11f8:	0e7030ef          	jal	4ade <close>
  pid = fork();
    11fc:	0b3030ef          	jal	4aae <fork>
  if(pid < 0){
...
000000000000133e <exectest>:
{
  ...
  unlink("echo-ok");
    ...
    136e:	798030ef          	jal	4b06 <unlink>
  pid = fork();
    1372:	73c030ef          	jal	4aae <fork>
  if(pid < 0) {
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    exit(1);
    14a8:	4505                	li	a0,1
    14aa:	60c030ef          	jal	4ab6 <exit>
    exit(0);
    14ae:	4501                	li	a0,0
    14b0:	606030ef          	jal	4ab6 <exit>
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16d0:	01f030ef          	jal	4eee <printf>
        exit(1);
    16d4:	4505                	li	a0,1
    16d6:	3e0030ef          	jal	4ab6 <exit>
      exit(i);
    16da:	854a                	mv	a0,s2
    16dc:	3da030ef          	jal	4ab6 <exit>
...
00000000000016e0 <twochildren>:
{
    ...
    1704:	c529                	beqz	a0,174e <twochildren+0x6e>
        wait(0);
    1706:	4501                	li	a0,0
    1708:	3b6030ef          	jal	4abe <wait>
        wait(0);
    170c:	4501                	li	a0,0
    170e:	3b0030ef          	jal	4abe <wait>
  for(int i = 0; i < 1000; i++){
    ...
    172c:	7c2030ef          	jal	4eee <printf>
      exit(1);
    1730:	4505                	li	a0,1
    1732:	384030ef          	jal	4ab6 <exit>
      exit(0);
    1736:	380030ef          	jal	4ab6 <exit>
        printf("%s: fork failed\n", s);
    173a:	85ca                	mv	a1,s2
    ...
    1744:	7aa030ef          	jal	4eee <printf>
        exit(1);
    1748:	4505                	li	a0,1
    174a:	36c030ef          	jal	4ab6 <exit>
        exit(0);
    174e:	368030ef          	jal	4ab6 <exit>
...
0000000000001752 <forkfork>:
{
    ...
    17a2:	74c030ef          	jal	4eee <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	30e030ef          	jal	4ab6 <exit>
{
    17ac:	0c800493          	li	s1,200
        int pid1 = fork();
    17b0:	2fe030ef          	jal	4aae <fork>
        if(pid1 < 0){
    ...
    17b8:	cd01                	beqz	a0,17d0 <forkfork+0x7e>
        wait(0);
    17ba:	4501                	li	a0,0
    17bc:	302030ef          	jal	4abe <wait>
      for(int j = 0; j < 200; j++){
    17c0:	34fd                	addiw	s1,s1,-1
    17c2:	f4fd                	bnez	s1,17b0 <forkfork+0x5e>
      exit(0);
    17c4:	4501                	li	a0,0
    17c6:	2f0030ef          	jal	4ab6 <exit>
          exit(1);
    17ca:	4505                	li	a0,1
    17cc:	2ea030ef          	jal	4ab6 <exit>
          exit(0);
    17d0:	2e6030ef          	jal	4ab6 <exit>
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1818:	6d6030ef          	jal	4eee <printf>
      exit(1);
    181c:	4505                	li	a0,1
    181e:	298030ef          	jal	4ab6 <exit>
      fork();
    1822:	28c030ef          	jal	4aae <fork>
      fork();
    1826:	288030ef          	jal	4aae <fork>
      exit(0);
    182a:	4501                	li	a0,0
    182c:	28a030ef          	jal	4ab6 <exit>
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    18de:	218030ef          	jal	4af6 <open>
        if(fd < 0){
    18e2:	fc0549e3          	bltz	a0,18b4 <createdelete+0x84>
        close(fd);
    18e6:	1f8030ef          	jal	4ade <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    191c:	5d2030ef          	jal	4eee <printf>
            exit(1);
    1920:	4505                	li	a0,1
    1922:	194030ef          	jal	4ab6 <exit>
      exit(0);
    1926:	4501                	li	a0,0
    1928:	18e030ef          	jal	4ab6 <exit>
      exit(1);
    192c:	4505                	li	a0,1
    192e:	188030ef          	jal	4ab6 <exit>
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a2c:	0da030ef          	jal	4b06 <unlink>
  pid = fork();
    1a30:	07e030ef          	jal	4aae <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    exit(1);
    1a78:	4505                	li	a0,1
    1a7a:	03c030ef          	jal	4ab6 <exit>
      close(open("x", O_RDWR | O_CREATE));
    1a7e:	20200593          	li	a1,514
    1a82:	855a                	mv	a0,s6
    1a84:	072030ef          	jal	4af6 <open>
    1a88:	056030ef          	jal	4ade <close>
  for(i = 0; i < 100; i++){
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    exit(1);
    1b18:	4505                	li	a0,1
    1b1a:	79d020ef          	jal	4ab6 <exit>
      exit(0);
    1b1e:	799020ef          	jal	4ab6 <exit>
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1c0c:	2e2030ef          	jal	4eee <printf>
      exit(1);
    1c10:	4505                	li	a0,1
    1c12:	6a5020ef          	jal	4ab6 <exit>
      exit(1);
    1c16:	4505                	li	a0,1
    1c18:	69f020ef          	jal	4ab6 <exit>
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c9e:	250030ef          	jal	4eee <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
    1ca4:	613020ef          	jal	4ab6 <exit>
      exit(1);
    1ca8:	4505                	li	a0,1
    1caa:	60d020ef          	jal	4ab6 <exit>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    exit(1);
    1d06:	4505                	li	a0,1
    1d08:	5af020ef          	jal	4ab6 <exit>
    exit(0);
    1d0c:	4501                	li	a0,0
    1d0e:	5a9020ef          	jal	4ab6 <exit>
...
0000000000001d12 <nowrite>:
{
  ...
  exit(0);
    ...
    1da6:	148030ef          	jal	4eee <printf>
      exit(1);
    1daa:	4505                	li	a0,1
    1dac:	50b020ef          	jal	4ab6 <exit>
      exit(1);
    1db0:	4505                	li	a0,1
    1db2:	505020ef          	jal	4ab6 <exit>
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1ebc:	032030ef          	jal	4eee <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
    1ec2:	3f5020ef          	jal	4ab6 <exit>
      exit(st);
    1ec6:	3f1020ef          	jal	4ab6 <exit>
...
0000000000001eca <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    1ed6:	469020ef          	jal	4b3e <sbrk>
  uint64 top = (uint64) sbrk(0);
    1eda:	4501                	li	a0,0
    1edc:	463020ef          	jal	4b3e <sbrk>
  if((top % PGSIZE) != 0){
    1ee0:	03451793          	slli	a5,a0,0x34
    1ee4:	e7bd                	bnez	a5,1f52 <copyinstr3+0x88>
  top = (uint64) sbrk(0);
    1ee6:	4501                	li	a0,0
    1ee8:	457020ef          	jal	4b3e <sbrk>
  if(top % PGSIZE){
...
0000000000001fce <rwsbrk>:
{
  ...
  if(n >= 0){
    ...
    exit(1);
    20c2:	4505                	li	a0,1
    20c4:	1f3020ef          	jal	4ab6 <exit>
  close(fd);
    20c8:	854a                	mv	a0,s2
    20ca:	215020ef          	jal	4ade <close>
  exit(0);
    20ce:	4501                	li	a0,0
    20d0:	1e7020ef          	jal	4ab6 <exit>
...
00000000000020d4 <sbrkbasic>:
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    exit(1);
    217c:	4505                	li	a0,1
    217e:	139020ef          	jal	4ab6 <exit>
    2182:	84be                	mv	s1,a5
    b = sbrk(1);
    2184:	4505                	li	a0,1
    2186:	1b9020ef          	jal	4b3e <sbrk>
    if(b != a){
  ...
  pid = fork();
    219e:	111020ef          	jal	4aae <fork>
    21a2:	892a                	mv	s2,a0
  if(pid < 0){
    21a4:	04054263          	bltz	a0,21e8 <sbrkbasic+0x114>
  c = sbrk(1);
    21a8:	4505                	li	a0,1
    21aa:	195020ef          	jal	4b3e <sbrk>
  c = sbrk(1);
    21ae:	4505                	li	a0,1
    21b0:	18f020ef          	jal	4b3e <sbrk>
  if(c != a + 1){
    ...
    exit(1);
    21f6:	4505                	li	a0,1
    21f8:	0bf020ef          	jal	4ab6 <exit>
  if(pid == 0)
    21fc:	00091563          	bnez	s2,2206 <sbrkbasic+0x132>
    exit(0);
    2200:	4501                	li	a0,0
    2202:	0b5020ef          	jal	4ab6 <exit>
  wait(&xstatus);
    2206:	fcc40513          	addi	a0,s0,-52
    220a:	0b5020ef          	jal	4abe <wait>
  exit(xstatus);
    220e:	fcc42503          	lw	a0,-52(s0)
    2212:	0a5020ef          	jal	4ab6 <exit>
...
0000000000002216 <sbrkmuch>:
{
  ...
  oldbrk = sbrk(0);
    2228:	4501                	li	a0,0
    222a:	115020ef          	jal	4b3e <sbrk>
    222e:	892a                	mv	s2,a0
  a = sbrk(0);
    2230:	4501                	li	a0,0
    2232:	10d020ef          	jal	4b3e <sbrk>
    2236:	84aa                	mv	s1,a0
  p = sbrk(amt);
    2238:	06400537          	lui	a0,0x6400
    223c:	9d05                	subw	a0,a0,s1
    223e:	101020ef          	jal	4b3e <sbrk>
  if (p != a) {
    2242:	0aa49463          	bne	s1,a0,22ea <sbrkmuch+0xd4>
  char *eee = sbrk(0);
    2246:	4501                	li	a0,0
    2248:	0f7020ef          	jal	4b3e <sbrk>
    224c:	87aa                	mv	a5,a0
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    226c:	4501                	li	a0,0
    226e:	0d1020ef          	jal	4b3e <sbrk>
    2272:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    2274:	757d                	lui	a0,0xfffff
    2276:	0c9020ef          	jal	4b3e <sbrk>
  if(c == (char*)0xffffffffffffffffL){
    227a:	57fd                	li	a5,-1
    227c:	08f50163          	beq	a0,a5,22fe <sbrkmuch+0xe8>
  c = sbrk(0);
    2280:	4501                	li	a0,0
    2282:	0bd020ef          	jal	4b3e <sbrk>
  if(c != a - PGSIZE){
  ...
  a = sbrk(0);
    228e:	4501                	li	a0,0
    2290:	0af020ef          	jal	4b3e <sbrk>
    2294:	84aa                	mv	s1,a0
  c = sbrk(PGSIZE);
    2296:	6505                	lui	a0,0x1
    2298:	0a7020ef          	jal	4b3e <sbrk>
    229c:	8a2a                	mv	s4,a0
  if(c != a || sbrk(0) != a + PGSIZE){
    229e:	08a49663          	bne	s1,a0,232a <sbrkmuch+0x114>
    22a2:	4501                	li	a0,0
    22a4:	09b020ef          	jal	4b3e <sbrk>
  ...
  a = sbrk(0);
    22c0:	4501                	li	a0,0
    22c2:	07d020ef          	jal	4b3e <sbrk>
    22c6:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    22c8:	4501                	li	a0,0
    22ca:	075020ef          	jal	4b3e <sbrk>
    22ce:	40a9053b          	subw	a0,s2,a0
    22d2:	06d020ef          	jal	4b3e <sbrk>
  if(c != a){
...
000000000000236e <sbrkarg>:
{
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    23aa:	85ca                	mv	a1,s2
    23ac:	8526                	mv	a0,s1
    23ae:	728020ef          	jal	4ad6 <write>
    23b2:	02054c63          	bltz	a0,23ea <sbrkarg+0x7c>
  close(fd);
    23b6:	8526                	mv	a0,s1
    23b8:	726020ef          	jal	4ade <close>
  a = sbrk(PGSIZE);
    23bc:	6505                	lui	a0,0x1
    23be:	780020ef          	jal	4b3e <sbrk>
  if(pipe((int *) a) != 0){
    23c2:	704020ef          	jal	4ac6 <pipe>
...
0000000000002412 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    242a:	6cc020ef          	jal	4af6 <open>
  if (fd < 0) {
    242e:	02054563          	bltz	a0,2458 <argptest+0x46>
    2432:	84aa                	mv	s1,a0
  read(fd, sbrk(0) - 1, -1);
    2434:	4501                	li	a0,0
    2436:	708020ef          	jal	4b3e <sbrk>
    243a:	567d                	li	a2,-1
    243c:	fff50593          	addi	a1,a0,-1
    2440:	8526                	mv	a0,s1
    2442:	68c020ef          	jal	4ace <read>
  close(fd);
    2446:	8526                	mv	a0,s1
    2448:	696020ef          	jal	4ade <close>
}
...
000000000000246c <sbrkbugs>:
{
  ...
  int pid = fork();
    2474:	63a020ef          	jal	4aae <fork>
  if(pid < 0){
    2478:	00054c63          	bltz	a0,2490 <sbrkbugs+0x24>
  if(pid == 0){
    247c:	e11d                	bnez	a0,24a2 <sbrkbugs+0x36>
    int sz = (uint64) sbrk(0);
    247e:	6c0020ef          	jal	4b3e <sbrk>
    sbrk(-sz);
    2482:	40a0053b          	negw	a0,a0
    2486:	6b8020ef          	jal	4b3e <sbrk>
    exit(0);
    248a:	4501                	li	a0,0
    248c:	62a020ef          	jal	4ab6 <exit>
    printf("fork failed\n");
  ...
  if(pid == 0){
    ...
    exit(1);
    24d6:	4505                	li	a0,1
    24d8:	5de020ef          	jal	4ab6 <exit>
  wait(0);
    24dc:	4501                	li	a0,0
    24de:	5e0020ef          	jal	4abe <wait>
  pid = fork();
    24e2:	5cc020ef          	jal	4aae <fork>
  if(pid < 0){
    24e6:	02054263          	bltz	a0,250a <sbrkbugs+0x9e>
  if(pid == 0){
    24ea:	e90d                	bnez	a0,251c <sbrkbugs+0xb0>
    sbrk((10*4096 + 2048) - (uint64)sbrk(0));
    24ec:	652020ef          	jal	4b3e <sbrk>
    24f0:	67ad                	lui	a5,0xb
    24f2:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x1298>
    24f6:	40a7853b          	subw	a0,a5,a0
    24fa:	644020ef          	jal	4b3e <sbrk>
    sbrk(-10);
    24fe:	5559                	li	a0,-10
    2500:	63e020ef          	jal	4b3e <sbrk>
    exit(0);
    2504:	4501                	li	a0,0
    2506:	5b0020ef          	jal	4ab6 <exit>
    printf("fork failed\n");
    ...
    exit(1);
    2516:	4505                	li	a0,1
    2518:	59e020ef          	jal	4ab6 <exit>
  wait(0);
    251c:	4501                	li	a0,0
    251e:	5a0020ef          	jal	4abe <wait>
  exit(0);
    2522:	4501                	li	a0,0
    2524:	592020ef          	jal	4ab6 <exit>
...
0000000000002528 <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    2538:	4501                	li	a0,0
    253a:	604020ef          	jal	4b3e <sbrk>
  if((top % 4096) != 0)
    253e:	03451793          	slli	a5,a0,0x34
    2542:	ebad                	bnez	a5,25b4 <sbrklast+0x8c>
  sbrk(4096);
    2544:	6505                	lui	a0,0x1
    2546:	5f8020ef          	jal	4b3e <sbrk>
  sbrk(10);
    254a:	4529                	li	a0,10
    254c:	5f2020ef          	jal	4b3e <sbrk>
  sbrk(-20);
    2550:	5531                	li	a0,-20
    2552:	5ec020ef          	jal	4b3e <sbrk>
  top = (uint64) sbrk(0);
    2556:	4501                	li	a0,0
    2558:	5e6020ef          	jal	4b3e <sbrk>
    255c:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2572:	854a                	mv	a0,s2
    2574:	582020ef          	jal	4af6 <open>
    2578:	89aa                	mv	s3,a0
  write(fd, p, 1);
    257a:	4605                	li	a2,1
    257c:	85ca                	mv	a1,s2
    257e:	558020ef          	jal	4ad6 <write>
  close(fd);
    2582:	854e                	mv	a0,s3
    2584:	55a020ef          	jal	4ade <close>
  fd = open(p, O_RDWR);
    2588:	4589                	li	a1,2
    258a:	854a                	mv	a0,s2
    258c:	56a020ef          	jal	4af6 <open>
  p[0] = '\0';
    2590:	fc048023          	sb	zero,-64(s1)
  read(fd, p, 1);
    2594:	4605                	li	a2,1
    2596:	85ca                	mv	a1,s2
    2598:	536020ef          	jal	4ace <read>
  if(p[0] != 'x')
    ...
    25be:	580020ef          	jal	4b3e <sbrk>
    25c2:	b749                	j	2544 <sbrklast+0x1c>
    exit(1);
    25c4:	4505                	li	a0,1
    25c6:	4f0020ef          	jal	4ab6 <exit>
...
00000000000025ca <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    25d8:	566020ef          	jal	4b3e <sbrk>
  volatile char *top = sbrk(0);
    25dc:	4501                	li	a0,0
    25de:	560020ef          	jal	4b3e <sbrk>
  *(top-1) = *(top-1) + 1;
...
00000000000025f8 <execout>:
{
  ...
  exit(0);
    ...
    268a:	464020ef          	jal	4aee <exec>
      exit(0);
    268e:	4501                	li	a0,0
    2690:	426020ef          	jal	4ab6 <exit>
...
00000000000027d0 <diskfull>:
{
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    283e:	a039                	j	284c <diskfull+0x7c>
        close(fd);
    2840:	854a                	mv	a0,s2
    2842:	29c020ef          	jal	4ade <close>
    close(fd);
    2846:	854a                	mv	a0,s2
    2848:	296020ef          	jal	4ade <close>
  for(int i = 0; i < nzz; i++){
    284c:	4481                	li	s1,0
    name[0] = 'z';
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29a0:	166020ef          	jal	4b06 <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
    29a4:	60200593          	li	a1,1538
    29a8:	b8040513          	addi	a0,s0,-1152
    29ac:	14a020ef          	jal	4af6 <open>
    29b0:	892a                	mv	s2,a0
    if(fd < 0){
...
0000000000002a8a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2b1c:	3d2020ef          	jal	4eee <printf>
      exit(1);
    2b20:	4505                	li	a0,1
    2b22:	795010ef          	jal	4ab6 <exit>
  wait(&xstatus);
    2b26:	fdc40513          	addi	a0,s0,-36
    2b2a:	795010ef          	jal	4abe <wait>
  exit(xstatus);
    2b2e:	fdc42503          	lw	a0,-36(s0)
    2b32:	785010ef          	jal	4ab6 <exit>
...
0000000000002bdc <subdir>:
{
  ...
  write(fd, "FF", 2);
    ...
    2c70:	667010ef          	jal	4ad6 <write>
  close(fd);
    2c74:	8526                	mv	a0,s1
    2c76:	669010ef          	jal	4ade <close>
  fd = open("dd/dd/../ff", 0);
    2c7a:	4581                	li	a1,0
    2c7c:	00003517          	auipc	a0,0x3
    2c80:	77450513          	addi	a0,a0,1908 # 63f0 <malloc+0x144e>
    2c84:	673010ef          	jal	4af6 <open>
    2c88:	84aa                	mv	s1,a0
  if(fd < 0){
...
00000000000034a0 <iref>:
{
    ...
    34fa:	1f5010ef          	jal	4eee <printf>
      exit(1);
    34fe:	4505                	li	a0,1
    3500:	5b6010ef          	jal	4ab6 <exit>
      close(fd);
    3504:	5da010ef          	jal	4ade <close>
    3508:	a82d                	j	3542 <iref+0xa2>
    unlink("xx");
    350a:	854e                	mv	a0,s3
    350c:	5fa010ef          	jal	4b06 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    3510:	397d                	addiw	s2,s2,-1
    3512:	04090263          	beqz	s2,3556 <iref+0xb6>
    if(mkdir("irefd") != 0){
    3516:	8552                	mv	a0,s4
    3518:	606010ef          	jal	4b1e <mkdir>
    351c:	f161                	bnez	a0,34dc <iref+0x3c>
    if(chdir("irefd") != 0){
    351e:	8552                	mv	a0,s4
    3520:	606010ef          	jal	4b26 <chdir>
    3524:	f571                	bnez	a0,34f0 <iref+0x50>
    mkdir("");
    3526:	8526                	mv	a0,s1
    3528:	5f6010ef          	jal	4b1e <mkdir>
    link("README", "");
    352c:	85a6                	mv	a1,s1
    352e:	8556                	mv	a0,s5
    3530:	5e6010ef          	jal	4b16 <link>
    fd = open("", O_CREATE);
    3534:	20000593          	li	a1,512
    3538:	8526                	mv	a0,s1
    353a:	5bc010ef          	jal	4af6 <open>
    if(fd >= 0)
    353e:	fc0553e3          	bgez	a0,3504 <iref+0x64>
    fd = open("xx", O_CREATE);
    3542:	20000593          	li	a1,512
    3546:	854e                	mv	a0,s3
    3548:	5ae010ef          	jal	4af6 <open>
    if(fd >= 0)
    354c:	fa054fe3          	bltz	a0,350a <iref+0x6a>
      close(fd);
    3550:	58e010ef          	jal	4ade <close>
    ...
    chdir("..");
    356a:	854e                	mv	a0,s3
    356c:	5ba010ef          	jal	4b26 <chdir>
    unlink("irefd");
    3570:	854a                	mv	a0,s2
    3572:	594010ef          	jal	4b06 <unlink>
  for(i = 0; i < NINODE + 1; i++){
...
000000000000359a <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    35ae:	570010ef          	jal	4b1e <mkdir>
    35b2:	02054a63          	bltz	a0,35e6 <openiputtest+0x4c>
  pid = fork();
    35b6:	4f8010ef          	jal	4aae <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    exit(1);
    3608:	4505                	li	a0,1
    360a:	4ac010ef          	jal	4ab6 <exit>
    exit(0);
    360e:	4501                	li	a0,0
    3610:	4a6010ef          	jal	4ab6 <exit>
  sleep(1);
    3614:	4505                	li	a0,1
    3616:	530010ef          	jal	4b46 <sleep>
  if(unlink("oidir") != 0){
    361a:	00003517          	auipc	a0,0x3
    361e:	4de50513          	addi	a0,a0,1246 # 6af8 <malloc+0x1b56>
    3622:	4e4010ef          	jal	4b06 <unlink>
    ...
    exit(1);
    3636:	4505                	li	a0,1
    3638:	47e010ef          	jal	4ab6 <exit>
  wait(&xstatus);
    363c:	fdc40513          	addi	a0,s0,-36
    3640:	47e010ef          	jal	4abe <wait>
  exit(xstatus);
    3644:	fdc42503          	lw	a0,-36(s0)
    3648:	46e010ef          	jal	4ab6 <exit>
...
000000000000364c <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3660:	4a6010ef          	jal	4b06 <unlink>
  int pid = fork();
    3664:	44a010ef          	jal	4aae <fork>
  if(pid < 0){
  ...
  sleep(20); // two seconds
    366e:	4551                	li	a0,20
    3670:	4d6010ef          	jal	4b46 <sleep>
  close(open("stopforking", O_CREATE|O_RDWR));
    3674:	20200593          	li	a1,514
    3678:	00003517          	auipc	a0,0x3
    367c:	4c850513          	addi	a0,a0,1224 # 6b40 <malloc+0x1b9e>
    3680:	476010ef          	jal	4af6 <open>
    3684:	45a010ef          	jal	4ade <close>
  wait(0);
    3688:	4501                	li	a0,0
    368a:	434010ef          	jal	4abe <wait>
  sleep(10); // one second
    368e:	4529                	li	a0,10
    3690:	4b6010ef          	jal	4b46 <sleep>
}
    ...
    36da:	41c010ef          	jal	4af6 <open>
    36de:	400010ef          	jal	4ade <close>
    36e2:	bfe1                	j	36ba <forkforkfork+0x6e>
        exit(0);
    36e4:	4501                	li	a0,0
    36e6:	3d0010ef          	jal	4ab6 <exit>
...
00000000000036ea <killstatus>:
{
    ...
    sleep(1);
    370e:	4505                	li	a0,1
    3710:	436010ef          	jal	4b46 <sleep>
    kill(pid1);
    3714:	8526                	mv	a0,s1
    3716:	3d0010ef          	jal	4ae6 <kill>
    wait(&xst);
    371a:	fcc40513          	addi	a0,s0,-52
    371e:	3a0010ef          	jal	4abe <wait>
    if(xst != -1) {
  ...
  exit(0);
    ...
    3740:	7ae010ef          	jal	4eee <printf>
      exit(1);
    3744:	4505                	li	a0,1
    3746:	370010ef          	jal	4ab6 <exit>
        getpid();
    374a:	3ec010ef          	jal	4b36 <getpid>
      while(1) {
...
0000000000003764 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    exit(1);
    3792:	4505                	li	a0,1
    3794:	322010ef          	jal	4ab6 <exit>
  pid2 = fork();
    3798:	316010ef          	jal	4aae <fork>
    379c:	89aa                	mv	s3,a0
  if(pid2 < 0) {
  ...
  if(pid2 == 0)
    ...
    exit(1);
    37b4:	4505                	li	a0,1
    37b6:	300010ef          	jal	4ab6 <exit>
  pipe(pfds);
    37ba:	fc840513          	addi	a0,s0,-56
    37be:	308010ef          	jal	4ac6 <pipe>
  pid3 = fork();
    37c2:	2ec010ef          	jal	4aae <fork>
    37c6:	8a2a                	mv	s4,a0
  if(pid3 < 0) {
  ...
  kill(pid1);
    386e:	8526                	mv	a0,s1
    3870:	276010ef          	jal	4ae6 <kill>
  kill(pid2);
    3874:	854e                	mv	a0,s3
    3876:	270010ef          	jal	4ae6 <kill>
  kill(pid3);
    387a:	8552                	mv	a0,s4
    387c:	26a010ef          	jal	4ae6 <kill>
  printf("wait... ");
  ...
  wait(0);
    388c:	4501                	li	a0,0
    388e:	230010ef          	jal	4abe <wait>
  wait(0);
    3892:	4501                	li	a0,0
    3894:	22a010ef          	jal	4abe <wait>
  wait(0);
    3898:	4501                	li	a0,0
    389a:	224010ef          	jal	4abe <wait>
...
00000000000038a0 <reparent>:
{
  ...
  int master_pid = getpid();
    38b2:	284010ef          	jal	4b36 <getpid>
    38b6:	8a2a                	mv	s4,a0
    38b8:	0c800913          	li	s2,200
    int pid = fork();
    38bc:	1f2010ef          	jal	4aae <fork>
    38c0:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  exit(0);
    ...
    38fc:	5f2010ef          	jal	4eee <printf>
        exit(1);
    3900:	4505                	li	a0,1
    3902:	1b4010ef          	jal	4ab6 <exit>
      int pid2 = fork();
    3906:	1a8010ef          	jal	4aae <fork>
      if(pid2 < 0){
    390a:	00054563          	bltz	a0,3914 <reparent+0x74>
      exit(0);
    390e:	4501                	li	a0,0
    3910:	1a6010ef          	jal	4ab6 <exit>
        kill(master_pid);
    3914:	8552                	mv	a0,s4
    3916:	1d0010ef          	jal	4ae6 <kill>
        exit(1);
    391a:	4505                	li	a0,1
    391c:	19a010ef          	jal	4ab6 <exit>
...
0000000000003920 <sbrkfail>:
{
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    39aa:	124010ef          	jal	4ace <read>
    39ae:	bff9                	j	398c <sbrkfail+0x6c>
  c = sbrk(PGSIZE);
    39b0:	6505                	lui	a0,0x1
    39b2:	18c010ef          	jal	4b3e <sbrk>
    39b6:	8a2a                	mv	s4,a0
    if(pids[i] == -1)
    39b8:	597d                	li	s2,-1
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    kill(pids[i]);
    39c8:	11e010ef          	jal	4ae6 <kill>
    wait(0);
    39cc:	4501                	li	a0,0
    39ce:	0f0010ef          	jal	4abe <wait>
    39d2:	b7ed                	j	39bc <sbrkfail+0x9c>
  if(c == (char*)0xffffffffffffffffL){
    39d4:	57fd                	li	a5,-1
    39d6:	02fa0d63          	beq	s4,a5,3a10 <sbrkfail+0xf0>
  pid = fork();
    39da:	0d4010ef          	jal	4aae <fork>
    39de:	84aa                	mv	s1,a0
  if(pid < 0){
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    exit(1);
    3a32:	4505                	li	a0,1
    3a34:	082010ef          	jal	4ab6 <exit>
    a = sbrk(0);
    3a38:	4501                	li	a0,0
    3a3a:	104010ef          	jal	4b3e <sbrk>
    3a3e:	892a                	mv	s2,a0
    sbrk(10*BIG);
    3a40:	3e800537          	lui	a0,0x3e800
    3a44:	0fa010ef          	jal	4b3e <sbrk>
    ...
    exit(1);
    3a6e:	4505                	li	a0,1
    3a70:	046010ef          	jal	4ab6 <exit>
    exit(1);
    3a74:	4505                	li	a0,1
    3a76:	040010ef          	jal	4ab6 <exit>
...
0000000000003a7a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ae2:	40c010ef          	jal	4eee <printf>
      exit(1);
    3ae6:	4505                	li	a0,1
    3ae8:	7cf000ef          	jal	4ab6 <exit>
      exit(0);
    3aec:	4501                	li	a0,0
    3aee:	7c9000ef          	jal	4ab6 <exit>
...
0000000000003af2 <sharedfd>:
{
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    exit(1);
    3c52:	4505                	li	a0,1
    3c54:	663000ef          	jal	4ab6 <exit>
    exit(0);
    3c58:	4501                	li	a0,0
    3c5a:	65d000ef          	jal	4ab6 <exit>
...
0000000000003c5e <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    unlink(fname);
    3cbc:	854e                	mv	a0,s3
    3cbe:	649000ef          	jal	4b06 <unlink>
    pid = fork();
    3cc2:	5ed000ef          	jal	4aae <fork>
    if(pid < 0){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d0c:	1e2010ef          	jal	4eee <printf>
      exit(1);
    3d10:	4505                	li	a0,1
    3d12:	5a5000ef          	jal	4ab6 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    3d16:	20200593          	li	a1,514
    3d1a:	854e                	mv	a0,s3
    3d1c:	5db000ef          	jal	4af6 <open>
    3d20:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    3d80:	16e010ef          	jal	4eee <printf>
          exit(1);
    3d84:	4505                	li	a0,1
    3d86:	531000ef          	jal	4ab6 <exit>
      exit(xstatus);
    3d8a:	8556                	mv	a0,s5
    3d8c:	52b000ef          	jal	4ab6 <exit>
          printf("%s: wrong char\n", s);
    3d90:	85e6                	mv	a1,s9
    ...
    close(fd);
    3dd2:	854e                	mv	a0,s3
    3dd4:	50b000ef          	jal	4ade <close>
    if(total != N*SZ){
    3dd8:	03a91463          	bne	s2,s10,3e00 <fourfiles+0x1a2>
    unlink(fname);
    3ddc:	8562                	mv	a0,s8
    3dde:	529000ef          	jal	4b06 <unlink>
  for(i = 0; i < NCHILD; i++){
...
0000000000003e32 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e9e:	050010ef          	jal	4eee <printf>
        exit(1);
    3ea2:	4505                	li	a0,1
    3ea4:	413000ef          	jal	4ab6 <exit>
      link("C0", file);
    3ea8:	fa840593          	addi	a1,s0,-88
    3eac:	00003517          	auipc	a0,0x3
    3eb0:	e7c50513          	addi	a0,a0,-388 # 6d28 <malloc+0x1d86>
    3eb4:	463000ef          	jal	4b16 <link>
      exit(0);
    3eb8:	4501                	li	a0,0
    3eba:	3fd000ef          	jal	4ab6 <exit>
        exit(1);
    3ebe:	4505                	li	a0,1
    3ec0:	3f7000ef          	jal	4ab6 <exit>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f64:	78b000ef          	jal	4eee <printf>
        exit(1);
    3f68:	4505                	li	a0,1
    3f6a:	34d000ef          	jal	4ab6 <exit>
  close(fd);
    3f6e:	854a                	mv	a0,s2
    3f70:	36f000ef          	jal	4ade <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    3fa4:	74b000ef          	jal	4eee <printf>
      exit(1);
    3fa8:	4505                	li	a0,1
    3faa:	30d000ef          	jal	4ab6 <exit>
      close(open(file, 0));
    3fae:	4581                	li	a1,0
    3fb0:	fa840513          	addi	a0,s0,-88
    3fb4:	343000ef          	jal	4af6 <open>
    3fb8:	327000ef          	jal	4ade <close>
      close(open(file, 0));
    3fbc:	4581                	li	a1,0
    3fbe:	fa840513          	addi	a0,s0,-88
    3fc2:	335000ef          	jal	4af6 <open>
    3fc6:	319000ef          	jal	4ade <close>
      close(open(file, 0));
    3fca:	4581                	li	a1,0
    3fcc:	fa840513          	addi	a0,s0,-88
    3fd0:	327000ef          	jal	4af6 <open>
    3fd4:	30b000ef          	jal	4ade <close>
      close(open(file, 0));
    3fd8:	4581                	li	a1,0
    3fda:	fa840513          	addi	a0,s0,-88
    3fde:	319000ef          	jal	4af6 <open>
    3fe2:	2fd000ef          	jal	4ade <close>
      close(open(file, 0));
    3fe6:	4581                	li	a1,0
    3fe8:	fa840513          	addi	a0,s0,-88
    3fec:	30b000ef          	jal	4af6 <open>
    3ff0:	2ef000ef          	jal	4ade <close>
      close(open(file, 0));
    3ff4:	4581                	li	a1,0
    3ff6:	fa840513          	addi	a0,s0,-88
    3ffa:	2fd000ef          	jal	4af6 <open>
    3ffe:	2e1000ef          	jal	4ade <close>
    if(pid == 0)
    4002:	06090363          	beqz	s2,4068 <concreate+0x236>
      wait(0);
    4006:	4501                	li	a0,0
    4008:	2b7000ef          	jal	4abe <wait>
  for(i = 0; i < N; i++){
    ...
    403a:	2cd000ef          	jal	4b06 <unlink>
      unlink(file);
    403e:	fa840513          	addi	a0,s0,-88
    4042:	2c5000ef          	jal	4b06 <unlink>
      unlink(file);
    4046:	fa840513          	addi	a0,s0,-88
    404a:	2bd000ef          	jal	4b06 <unlink>
      unlink(file);
    404e:	fa840513          	addi	a0,s0,-88
    4052:	2b5000ef          	jal	4b06 <unlink>
      unlink(file);
    4056:	fa840513          	addi	a0,s0,-88
    405a:	2ad000ef          	jal	4b06 <unlink>
      unlink(file);
    405e:	fa840513          	addi	a0,s0,-88
    4062:	2a5000ef          	jal	4b06 <unlink>
    4066:	bf71                	j	4002 <concreate+0x1d0>
      exit(0);
    4068:	4501                	li	a0,0
    406a:	24d000ef          	jal	4ab6 <exit>
      close(fd);
    406e:	271000ef          	jal	4ade <close>
    if(pid == 0) {
    4072:	b599                	j	3eb8 <concreate+0x86>
      close(fd);
    4074:	26b000ef          	jal	4ade <close>
      wait(&xstatus);
    4078:	f6c40513          	addi	a0,s0,-148
    407c:	243000ef          	jal	4abe <wait>
      if(xstatus != 0)
  ...
  for(i = 0; i < N; i++){
    ...
    409a:	26d000ef          	jal	4b06 <unlink>
    pid = fork();
    409e:	211000ef          	jal	4aae <fork>
    if(pid && (i % 3) == 1){
...
00000000000040d6 <bigfile>:
{
  ...
  for(i = 0; ; i++){
    ...
    420e:	4e1000ef          	jal	4eee <printf>
      exit(1);
    4212:	4505                	li	a0,1
    4214:	0a3000ef          	jal	4ab6 <exit>
  close(fd);
    4218:	8552                	mv	a0,s4
    421a:	0c5000ef          	jal	4ade <close>
  if(total != N*SZ){
...
000000000000425a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    426e:	099000ef          	jal	4b06 <unlink>
  pid = fork();
    4272:	03d000ef          	jal	4aae <fork>
  if(pid == 0){
  ...
  fd = open("bigarg-ok", 0);
    ...
    4294:	063000ef          	jal	4af6 <open>
  if(fd < 0){
    4298:	08054663          	bltz	a0,4324 <bigargtest+0xca>
  close(fd);
    429c:	043000ef          	jal	4ade <close>
}
    ...
    42ee:	001000ef          	jal	4aee <exec>
    fd = open("bigarg-ok", O_CREATE);
    42f2:	20000593          	li	a1,512
    42f6:	00003517          	auipc	a0,0x3
    42fa:	bc250513          	addi	a0,a0,-1086 # 6eb8 <malloc+0x1f16>
    42fe:	7f8000ef          	jal	4af6 <open>
    close(fd);
    4302:	7dc000ef          	jal	4ade <close>
    exit(0);
    4306:	4501                	li	a0,0
    4308:	7ae000ef          	jal	4ab6 <exit>
    ...
    exit(1);
    431a:	4505                	li	a0,1
    431c:	79a000ef          	jal	4ab6 <exit>
    exit(xstatus);
    4320:	796000ef          	jal	4ab6 <exit>
...
run(void f(char *), char *s) {
  ...
  if(pid == 0) {
    ...
    exit(1);
    450e:	4505                	li	a0,1
    4510:	5a6000ef          	jal	4ab6 <exit>
    f(s);
    4514:	854a                	mv	a0,s2
    4516:	9482                	jalr	s1
    exit(0);
    4518:	4501                	li	a0,0
    451a:	59c000ef          	jal	4ab6 <exit>
      printf("OK\n");
...
countfree()
{
  ...
  if(pid == 0){
    ...
    exit(1);
    463c:	4505                	li	a0,1
    463e:	478000ef          	jal	4ab6 <exit>
      }
    }

    exit(0);
    4642:	4501                	li	a0,0
    4644:	472000ef          	jal	4ab6 <exit>
    4648:	f426                	sd	s1,40(sp)
  }

  close(fds[1]);
    464a:	fcc42503          	lw	a0,-52(s0)
    464e:	490000ef          	jal	4ade <close>
  ...
  while(1){
    ...
    4678:	077000ef          	jal	4eee <printf>
      exit(1);
    467c:	4505                	li	a0,1
    467e:	438000ef          	jal	4ab6 <exit>
  }

  close(fds[0]);
    4682:	fc842503          	lw	a0,-56(s0)
    4686:	458000ef          	jal	4ade <close>
  wait((int*)0);
    468a:	4501                	li	a0,0
    468c:	432000ef          	jal	4abe <wait>
...
stat(const char *n, struct stat *st)
{
  ...
  r = fstat(fd, st);
    496a:	85ca                	mv	a1,s2
    496c:	1a2000ef          	jal	4b0e <fstat>
    4970:	892a                	mv	s2,a0
  close(fd);
    4972:	8526                	mv	a0,s1
    4974:	16a000ef          	jal	4ade <close>
  return r;
...
strncmp(const char *p, const char *q, uint n)
{
  ...
  while(n > 0 && *p && *p == *q)
    4a7e:	ce11                	beqz	a2,4a9a <strncmp+0x22>
    4a80:	00054783          	lbu	a5,0(a0)
    4a84:	cf89                	beqz	a5,4a9e <strncmp+0x26>
    4a86:	0005c703          	lbu	a4,0(a1)
    4a8a:	00f71a63          	bne	a4,a5,4a9e <strncmp+0x26>
    n--, p++, q++;
    4a8e:	367d                	addiw	a2,a2,-1
    4a90:	0505                	addi	a0,a0,1
    4a92:	0585                	addi	a1,a1,1
  while(n > 0 && *p && *p == *q)
    4a94:	f675                	bnez	a2,4a80 <strncmp+0x8>
  if(n == 0)
    return 0;
    4a96:	4501                	li	a0,0
    4a98:	a801                	j	4aa8 <strncmp+0x30>
    4a9a:	4501                	li	a0,0
    4a9c:	a031                	j	4aa8 <strncmp+0x30>
  return (uchar)*p - (uchar)*q;
    4a9e:	00054503          	lbu	a0,0(a0)
    4aa2:	0005c783          	lbu	a5,0(a1)
    4aa6:	9d1d                	subw	a0,a0,a5
}
    4aa8:	6422                	ld	s0,8(sp)
    4aaa:	0141                	addi	sp,sp,16
    4aac:	8082                	ret

0000000000004aae <fork>:
...
{
    4b94:	715d                	addi	sp,sp,-80
    4b96:	e486                	sd	ra,72(sp)
    4b98:	e0a2                	sd	s0,64(sp)
    4b9a:	fc26                	sd	s1,56(sp)
    4b9c:	0880                	addi	s0,sp,80
    4b9e:	84aa                	mv	s1,a0
  char buf[20];
  int i, neg;
  uint x;
  ...
  while(--i >= 0)
    ...
    4c26:	7942                	ld	s2,48(sp)
    4c28:	79a2                	ld	s3,40(sp)
}
    4c2a:	60a6                	ld	ra,72(sp)
    4c2c:	6406                	ld	s0,64(sp)
    4c2e:	74e2                	ld	s1,56(sp)
    4c30:	6161                	addi	sp,sp,80
    4c32:	8082                	ret
    x = -xx;
