...
strncmp(const char *p, const char *q, uint n)
{
 ...
 350:	0800                	addi	s0,sp,16
  while(n > 0 && *p && *p == *q)
 352:	ce11                	beqz	a2,36e <strncmp+0x22>
 354:	00054783          	lbu	a5,0(a0)
 358:	cf89                	beqz	a5,372 <strncmp+0x26>
 35a:	0005c703          	lbu	a4,0(a1)
 35e:	00f71a63          	bne	a4,a5,372 <strncmp+0x26>
    n--, p++, q++;
 362:	367d                	addiw	a2,a2,-1
 364:	0505                	addi	a0,a0,1
 366:	0585                	addi	a1,a1,1
  while(n > 0 && *p && *p == *q)
 368:	f675                	bnez	a2,354 <strncmp+0x8>
  if(n == 0)
    return 0;
 36a:	4501                	li	a0,0
 36c:	a801                	j	37c <strncmp+0x30>
 36e:	4501                	li	a0,0
 370:	a031                	j	37c <strncmp+0x30>
  return (uchar)*p - (uchar)*q;
 372:	00054503          	lbu	a0,0(a0)
 376:	0005c783          	lbu	a5,0(a1)
 37a:	9d1d                	subw	a0,a0,a5
}
 37c:	6422                	ld	s0,8(sp)
