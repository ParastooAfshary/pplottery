...
strncmp(const char *p, const char *q, uint n)
{
 ...
 2e0:	0800                	addi	s0,sp,16
  while(n > 0 && *p && *p == *q)
 2e2:	ce11                	beqz	a2,2fe <strncmp+0x22>
 2e4:	00054783          	lbu	a5,0(a0)
 2e8:	cf89                	beqz	a5,302 <strncmp+0x26>
 2ea:	0005c703          	lbu	a4,0(a1)
 2ee:	00f71a63          	bne	a4,a5,302 <strncmp+0x26>
    n--, p++, q++;
 2f2:	367d                	addiw	a2,a2,-1
 2f4:	0505                	addi	a0,a0,1
 2f6:	0585                	addi	a1,a1,1
  while(n > 0 && *p && *p == *q)
 2f8:	f675                	bnez	a2,2e4 <strncmp+0x8>
  if(n == 0)
    return 0;
 2fa:	4501                	li	a0,0
 2fc:	a801                	j	30c <strncmp+0x30>
 2fe:	4501                	li	a0,0
 300:	a031                	j	30c <strncmp+0x30>
  return (uchar)*p - (uchar)*q;
 302:	00054503          	lbu	a0,0(a0)
 306:	0005c783          	lbu	a5,0(a1)
 30a:	9d1d                	subw	a0,a0,a5
}
 30c:	6422                	ld	s0,8(sp)
